        ...
        {statsLoading ? (
          ...
          <>
            <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-surface">
              <p className="text-sm font-medium uppercase tracking-[0.1em] text-neutral-500">Running Contracts</p>
            ...
            <div className="rounded-3xl border border-green-100 bg-green-50 p-6">
              <p className="text-sm font-medium uppercase tracking-[0.1em] text-green-700">Completed</p>
              <p className="mt-4 text-3xl font-semibold text-green-800">{stats?.completedContracts ?? 0}</p>
            </div>
            <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-surface">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-surface">
          ...
          <div className="grid gap-3">
            <Link to="/contracts" className="rounded-2xl border border-neutral-200 bg-white p-4 text-sm font-medium text-neutral-700 transition hover:bg-neutral-50">
              View All Contracts
            </Link>
            <Link to="/contractors" className="rounded-2xl border border-neutral-200 bg-white p-4 text-sm font-medium text-neutral-700 transition hover:bg-neutral-50">
              Manage Contractors
            </Link>
