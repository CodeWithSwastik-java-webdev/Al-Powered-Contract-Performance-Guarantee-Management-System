  ...
  return (
    <div className="space-y-8">
      <header>
        ...
        <p className="mt-2 text-sm text-neutral-600">Read-only access to reports and portfolio overview</p>
      </header>
        ...
        {statsLoading ? (
          ...
          <>
            <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-surface">
              <p className="text-sm font-medium uppercase tracking-[0.1em] text-neutral-500">Total Contracts</p>
