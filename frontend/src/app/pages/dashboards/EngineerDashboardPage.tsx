...
interface DashboardStats {
  ...
  activeCpgs: number
  pendingVerificationCpgs: number
  expiringSoon: number
        ...
        {statsLoading ? (
          ...
          <>
            <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-surface">
              <p className="text-sm font-medium uppercase tracking-[0.1em] text-neutral-500">Assigned Projects</p>
            ...
            <div className="rounded-3xl border border-amber-100 bg-amber-50 p-6">
              <p className="text-sm font-medium uppercase tracking-[0.1em] text-amber-700">Pending Verification</p>
              <p className="mt-4 text-3xl font-semibold text-amber-800">{stats?.pendingVerificationCpgs ?? 0}</p>
            </div>
