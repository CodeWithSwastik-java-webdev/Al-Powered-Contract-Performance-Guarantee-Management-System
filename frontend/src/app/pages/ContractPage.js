    ...
    const cpgColumns = [
        {
            key: 'cpgNumber',
            header: 'CPG No.',
            render: (row) => _jsx("span", { className: "font-medium text-neutral-900", children: row.cpgNumber }),
        },
        {
            key: 'amount',
            header: 'Amount',
