...
import { getHomeForRole, type AppRole } from '../config/rbac'

export interface AppUser { id: string; email: string; name: string; role: AppRole; status: string; contractorId?: string }
